...
function ProjectModal({ project, isOpen, onClose }) {
  ...
  // In a real project, you'd have multiple images per project
  const projectImages = [
    project.image,
    project.image, // You would replace these with actual different images
    project.image,
  ]
  ...
  // Mock additional project data - in real app, this would come from your data
  const projectDetails = {
    ...
    technologies: project.techstack.split(", "),
  }
                ...
                <div className="relative h-80 md:h-96 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {projectDetails.technologies.slice(0, 3).map((tech, index) => (
                        <span
                          key={index}
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-white font-medium">{projectDetails.team}</p>
                        </div>
                        <div>
                          <span className="text-gray-400 text-sm">Role</span>
                          <p className="text-white font-medium">{projectDetails.role}</p>
                        </div>
                      </div>
                    </motion.div>
